...
export const translations: Record<Locale, Record<string, string>> = {
  ...
  'en': {
    ...
    // App Info (missing from original)
    'app.name': 'Narcissist Radar',
    'app.tagline': 'Clarity for toxic relationships',
    'app.description': 'Support tool to identify and document abusive patterns',
    
    // Navigation (additional)
    'navigation.home': 'Home',
    'navigation.dashboard': 'Dashboard',
    'navigation.diary': 'Diary',
    'navigation.clarity_test': 'Clarity Test',
    'navigation.ai_coach': 'AI Coach',
    ...
    'dashboard.subtitle': 'Your clarity journey starts here',
    'dashboard.recent_entries': 'Recent Entries',
    'dashboard.mood_tracker': 'Mood Tracker',
    'dashboard.risk_indicators': 'Risk Indicators',
    'dashboard.next_steps': 'Next Steps',
    'dashboard.view_all': 'View All',
    
    // Diary
    'diary.title': 'Emotional Diary',
    'diary.new_entry': 'New Entry',
    'diary.entry_title': 'Entry Title',
    'diary.entry_content': 'What happened?',
    'diary.how_feel': 'How are you feeling?',
    'diary.tags_suggested': 'Suggested',
    'diary.risk_level': 'Risk Level',
    'diary.save_entry': 'Save Entry',
    'diary.timeline': 'Timeline',
    'diary.no_entries': 'No entries yet',
    
    // Clarity Test
    'clarity_test.title': 'Clarity Test',
    'clarity_test.subtitle': 'Self-assessment to gain clarity about your relationship',
    'clarity_test.start_test': 'Start Test',
    'clarity_test.question': 'Question',
    'clarity_test.progress': 'Progress',
    'clarity_test.finish': 'Finish',
    'clarity_test.results': 'Results',
    'clarity_test.score': 'Score',
    'clarity_test.interpretation': 'Interpretation',
    'clarity_test.recommendations': 'Recommendations',
    
    // AI Coach
    'ai_coach.title': 'Clarity Coach',
    'ai_coach.subtitle': 'Chat with our AI to gain perspective',
    'ai_coach.ask_question': 'Ask a question',
    'ai_coach.type_message': 'Type your message...',
    'ai_coach.send': 'Send',
    'ai_coach.thinking': 'Thinking...',
    'ai_coach.response': 'Response',
    'ai_coach.examples': 'Example questions:',
    ...
    // Plans (additional properties - avoiding duplicates)
    'plans.popular': 'POPULAR',
  ...
  'es': {
    ...
    // App Info (missing from original)
    'app.name': 'Radar Narcisista',
    'app.tagline': 'Claridad para relaciones tóxicas',
    'app.description': 'Herramienta de apoyo para identificar y documentar patrones abusivos',
    
    // Navigation (additional)
    'navigation.home': 'Inicio',
    'navigation.dashboard': 'Panel',
    'navigation.diary': 'Diario',
    'navigation.clarity_test': 'Test de Claridad',
    'navigation.ai_coach': 'Coach IA',
    ...
    'dashboard.subtitle': 'Tu viaje de claridad comienza aquí',
    'dashboard.recent_entries': 'Entradas Recientes',
    'dashboard.mood_tracker': 'Rastreador de Humor',
    'dashboard.risk_indicators': 'Indicadores de Riesgo',
    ...
    'diary.entry_title': 'Título de la Entrada',
    'diary.entry_content': '¿Qué pasó?',
    'diary.how_feel': '¿Cómo te sientes?',
    'diary.tags_suggested': 'Sugeridas',
    'diary.risk_level': 'Nivel de Riesgo',
    'diary.save_entry': 'Guardar Entrada',
    'diary.timeline': 'Línea de Tiempo',
    'diary.no_entries': 'Sin entradas aún',
    
    // Clarity Test
    'clarity_test.title': 'Test de Claridad',
    'clarity_test.subtitle': 'Autoevaluación para ganar claridad sobre tu relación',
    'clarity_test.start_test': 'Iniciar Test',
    'clarity_test.question': 'Pregunta',
    'clarity_test.progress': 'Progreso',
    'clarity_test.finish': 'Finalizar',
    'clarity_test.results': 'Resultados',
    'clarity_test.score': 'Puntuación',
    'clarity_test.interpretation': 'Interpretación',
    'clarity_test.recommendations': 'Recomendaciones',
    
    // AI Coach
    'ai_coach.title': 'Coach de Claridad',
    'ai_coach.subtitle': 'Chatea con nuestra IA para ganar perspectiva',
    'ai_coach.ask_question': 'Haz una pregunta',
    'ai_coach.type_message': 'Escribe tu mensaje...',
    'ai_coach.send': 'Enviar',
    'ai_coach.thinking': 'Pensando...',
    'ai_coach.response': 'Respuesta',
    'ai_coach.examples': 'Ejemplos de preguntas:',
    ...
    'plans.downgrade': 'Degradar',
    'plans.cancel': 'Cancelar Plan',
    'plans.current_plan': 'Plan Actual',
    'plans.choose_plan': 'Elegir Plan',
    ...
    'errors.try_again': 'Intenta de nuevo',
    'errors.contact_support': 'Contactar soporte',
